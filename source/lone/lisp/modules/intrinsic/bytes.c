...
#define LONE_LISP_EXPORT_BYTES_WRITER_PRIMITIVE(sign, bits, endian) \
	...
	LONE_LISP_EXPORT_BYTES_WRITER_PRIMITIVE(s, 64, /* native endianness */);
	...
	LONE_LISP_EXPORT_BYTES_READER_PRIMITIVE(u, 64, le);
	LONE_LISP_EXPORT_BYTES_READER_PRIMITIVE(s, 64, le);
	...
	LONE_LISP_EXPORT_BYTES_WRITER_PRIMITIVE(u, 64, le);
	LONE_LISP_EXPORT_BYTES_WRITER_PRIMITIVE(s, 64, le);
	...
	LONE_LISP_EXPORT_BYTES_READER_PRIMITIVE(u, 64, be);
	LONE_LISP_EXPORT_BYTES_READER_PRIMITIVE(s, 64, be);
	...
	LONE_LISP_EXPORT_BYTES_WRITER_PRIMITIVE(u, 64, be);
	LONE_LISP_EXPORT_BYTES_WRITER_PRIMITIVE(s, 64, be);
...
LONE_LISP_BYTES_WRITER_PRIMITIVE(s, 64, /* native endianness */)
...
LONE_LISP_BYTES_READER_PRIMITIVE(u, 64, le)
LONE_LISP_BYTES_READER_PRIMITIVE(s, 64, le)
...
LONE_LISP_BYTES_WRITER_PRIMITIVE(u, 64, le)
LONE_LISP_BYTES_WRITER_PRIMITIVE(s, 64, le)
...
LONE_LISP_BYTES_READER_PRIMITIVE(u, 64, be)
LONE_LISP_BYTES_READER_PRIMITIVE(s, 64, be)
...
LONE_LISP_BYTES_WRITER_PRIMITIVE(u, 64, be)
LONE_LISP_BYTES_WRITER_PRIMITIVE(s, 64, be)
